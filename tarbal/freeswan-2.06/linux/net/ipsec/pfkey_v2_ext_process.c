 ...
 * for more details.
 *
 * RCSID $Id: pfkey_v2_ext_process.c,v 1.16 2004/02/24 17:17:04 mcr Exp $
 */
...
char pfkey_v2_ext_process_c_version[] = "$Id: pfkey_v2_ext_process.c,v 1.16 2004/02/24 17:17:04 mcr Exp $";
