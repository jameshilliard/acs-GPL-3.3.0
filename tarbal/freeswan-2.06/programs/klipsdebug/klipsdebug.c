...
char klipsdebug_c_version[] = "RCSID $Id: klipsdebug.c,v 1.57 2004/02/24 18:20:31 mcr Exp $";
...
usage(char * arg)
{
	fprintf(stdout, "usage: %s {--set|--clear} {tunnel|xmit|netlink|xform|eroute|spi|radij|esp|ah|rcv|pfkey|ipcomp|verbose}\n", arg);
 ...
 *
 * Revision 1.54  2003/12/05 16:10:42  mcr
