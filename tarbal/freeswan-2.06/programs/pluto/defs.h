 ...
 * for more details.
 *
 * RCSID $Id: defs.h,v 1.37 2004/02/05 17:18:10 mcr Exp $
 */

#ifndef _PLUTO_DEFS_H
#define _PLUTO_DEFS_H
...
#ifdef IGNORE_NEXTHOP
#define IGNORE_NEXTHOPP(x) (1)
#else
#define IGNORE_NEXTHOPP(x) (x)
#endif
