 ...
 * for more details.
 *
 * RCSID $Id: constants.h,v 1.118 2004/02/19 15:54:28 dhr Exp $
 */
...
#ifndef FREESWANSITE
#define FREESWANSITE "http://www.freeswan.org"
#endif
 ...
 */
typedef const struct keyword_enum_value sparse_names[];
...
extern const unsigned char sparse_end[];
...
enum connection_kind {
    CK_IMPOSSIBLE,      /* policy is incomplete, can not use it yet */
...
#define POLICY_COMPRESS      LELEM(3)	/* must be second */
#define POLICY_PFS           LELEM(4)
#define POLICY_DISABLEARRIVALCHECK  LELEM(5)	/* supress tunnel egress address checking */
...
#define POLICY_SHUNT_SHIFT	6	/* log2(POLICY_SHUNT_PASS) */
...
#define POLICY_FAIL_SHIFT	8	/* log2(POLICY_FAIL_PASS) */
 ...
 */
#define POLICY_DONT_REKEY     LELEM(10)	/* don't rekey state either Phase */
#define POLICY_OPPO     LELEM(11)	/* is this opportunistic? */
#define POLICY_GROUP	LELEM(12)	/* is this a group template? */
#define POLICY_GROUTED	LELEM(13)	/* do we want this group routed? */
#define POLICY_UP	LELEM(14)	/* do we want this up? */
...
#define OAKLEY_ISAKMP_SA_LIFETIME_MAXIMUM 28800   /* eight hours */
