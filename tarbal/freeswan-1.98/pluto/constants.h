 ...
 * for more details.
 *
 * RCSID $Id: constants.h,v 1.82 2002/03/21 22:43:26 dhr Exp $
 */
...
#define POLICY_PASS     LELEM(8)
#define POLICY_DROP     LELEM(9)
/* PASS | DROP is construed as REJECT */

#define POLICY_OPPO_SHIFT	8	/* log2(POLICY_PASS) */
