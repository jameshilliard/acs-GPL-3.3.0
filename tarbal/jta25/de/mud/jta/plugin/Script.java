 ...
 *
 * @version $Id: Script.java,v 1.3 2004/07/01 18:25:49 jennifer Exp $
    ...
    bus.registerPluginListener(new ConfigurationListener() {
      public void setConfiguration(PluginConfig config) {
        ...
        //String s = config.getProperty("Script", id, "script");
		  /* Changed for Cyclades to automatically input username and password 
		     if asked for when telnet protocol authtype is not none */
			String s = "login:|" + Applet.user + "|Password:|" + Applet.password;
        if(s != null) {
