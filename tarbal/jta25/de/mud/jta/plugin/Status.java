 ...
 *
 * @version $Id: Status.java,v 1.3 2004/06/19 22:45:48 jennifer Exp $
  ...
  public Status(PluginBus bus, final String id) {
    ...
    bus.registerPluginListener(new OnlineStatusListener() {
      public void online() {
        ...
        if (infoURL == null) {
			if (Applet.protocol.equals("89") && Applet.portChosenSsh != null 
					&& Applet.portChosenSsh.equals("22") == false) {
					//[RK]Mar/03/05 - when Nat/SSH port has the master TCP port
					if (Applet.NatClustering != null) {
						port = Applet.port; 
					} else {
						port = Applet.portChosenSsh;
					}
         	} 
