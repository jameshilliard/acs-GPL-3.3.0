...
# compiled.
TCL_SRC_DIR='/dist/rpm/BUILD/tcltk/BUILD/tcltk-8.3.3/tcl8.3.3'

# String to pass to linker to pick up the Tcl library from its
# build directory.
TCL_BUILD_LIB_SPEC='-L/dist/rpm/BUILD/tcltk/BUILD/tcltk-8.3.3/tcl8.3.3/unix -ltcl${TCL_DBGX}'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/dist/rpm/BUILD/tcltk/BUILD/tcltk-8.3.3/tcl8.3.3/unix -ltclstub${TCL_DBGX}'
